    ...
    .then((data) => {
      ...
      data.forEach((item) => {
        ...
        <span class="product-details">
            ...
            <p class="m-1 fs-6"><span class='comcon'>${item.con}</span></p>
...
window.onload = function () {
  ...
  if (userToken) {
    ...
    console.log($("#navUser").html());
    if ($("#navUser").html() == `<i class="fa-solid fa-user"></i>`) {
      $("#navUser").removeClass("login");
    } else {
  ...
  navUser.onclick = function () {
    if (userToken) {
      ...
      var hereLocation = window.location.href.substring(21);
      if (hereLocation == "") {
        hereLocation = "/";
      }
...
$(document).ready(function () {
  ...
  function addProduct(addButton) {
    ...
    let wowprice2 = container.find(".price5").text();
    let wowprice3 = container.find(".price6");
    let fm = $(".fm");
    ...
    if (productName === "自選蔬果箱") {
      if (commodity === "雙人箱(1~2人)") {
        price = parseInt(wowprice, 10);
      } else if (commodity === "家庭箱(3~4人)") {
        price = parseInt(wowprice, 10) + 200;
        wowprice3.text(price);
      } else {
        price = parseInt(wowprice2, 10);
      }
    } else {
      if (
        commodity === "雙人箱(1~2人)" ||
        ...
        price = parseInt(doublePriceText, 10);
        ...
        price = parseInt(familyPriceText, 10);
        if (commodity === "家庭箱(30day)" || commodity === "家庭箱(60day)") {
          price *= 4;
        }
      } else {
        Swal.fire({
    ...
    if (commodity == "雙人箱(1~2人)" || commodity == "家庭箱(3~4人)") {
      lostcommodity = "";
    }
    let newProduct = `
  ...
  $("select").on("change", function (evt) {
    ...
    let day = div.find(".day option:selected");
    let commodity = container
      .find(".commodity:first option:selected")
      .text()
      .replace(/\s+/g, "");
    ...
    if (commodity === "雙人箱(30day)" || commodity === "雙人箱(60day)") {
      const price4Text = $(".price4").text();
      const price4Value = parseInt(price4Text, 10);
      if (!isNaN(price4Value)) {
        $(".price5").text(price4Value * 4);
      } else {
        console.error("Invalid price4 value:", price4Text);
      }
    }
    if (commodity == "家庭箱(30day)" || commodity == "家庭箱(60day)") {
      const price6Text = $(".price6").text();
      const price6Value = parseInt(price6Text, 10);
      if (!isNaN(price6Value)) {
        $(".price5").text(price6Value * 4);
      } else {
        console.error("Invalid price6 value:", price6Text);
      }
    }
    if (
      commodity == "雙人箱(30day)" ||
